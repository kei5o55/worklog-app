...
export default function UserProfilePage({
  ...
  const [bgmMemo, setBgmMemo] = useState<string>("");
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-6 space-y-8 bg-slate-50 min-h-screen text-slate-800">
      ...
      {/* 2. 提供いただいた TotalStatsCard コンポーネント */}
      <TotalStatsCard commits={commits} projects={projects} />

      {/* 3. 完了プロジェクト ＆ 進捗画像ギャラリー */}
